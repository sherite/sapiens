app.factory("AssistancesClausesGeneralFactory", function () {

    var assistancesClausesGeneral = '';
    var actions = "";
    var ClausesGeneralFactory = {};

    ClausesGeneralFactory.assistancesClausesGeneral = assistancesClausesGeneral;
    ClausesGeneralFactory.actions = actions;
    ClausesGeneralFactory.data = {
        ID: "",
        Alias: "",
        Name: "",
        LastName: "",
    ...
    return ClausesGeneralFactory;
});

app.controller("AssistancesClausesGeneralController", function ($scope, $location, $translate, $http, UsersFactory, $compile) {

    $scope.$on("languageChanged", function (evt, data) {

        var dTable = $("#AssistancesClausesGeneralTable").DataTable();
    ...
    $scope.Initialize = function () {
        ...
        $scope.lblUsersIU = UsersFactory.lblUsersIU = 'ASISTENCIAS - CONDICIONES GENERALES';
...
app.controller("AssistancesClausesGeneralViewController", function ($scope, $location, $translate, $http, UsersFactory) {
...
app.controller("AssistancesClausesGeneralEditController", function ($scope, $location, $translate, $http, UsersFactory) {
