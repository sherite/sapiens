	...
	pageLength: function ( dt ) {
		...
		var text = function ( dt ) {
            return dt.i18n('buttons.pageLength', {
				"-1":
					currentLang === english ? 'Show all rows' :
						currentLang === spanish || currentLang === undefined ? 'Mostrar todas las filas' :
							currentLang === brazilian ? 'Mostrar todos los registros' :
								currentLang === french ? 'Montrer tous les enregistrements' :
									currentLang === deutsche ? 'Alle Datensätze anzeigen' :
										'Mostra tutte le righe',
				_:
					currentLang === english ? 'Show %d rows' :
						currentLang === spanish || currentLang === undefined ? 'Mostrar %d filas' :
							currentLang === brazilian ? 'Mostrar %d registros' :
								currentLang === french ? 'Montrer %d enregistrements' :
									currentLang === deutsche ? '%d Datensätze anzeigen' :
										'Mostra %d righe'
			}, dt.page.len() );
		};
