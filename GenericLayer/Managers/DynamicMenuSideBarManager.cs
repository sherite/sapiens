namespace Entities.Managers
{
    ...
    public class DynamicMenuSideBarManager : IDisposable
    {
        ...
        public HorusDL.DynamicMenuSideBar DynamicMenuSideBar { get; set; }

        public DynamicMenuSideBarManager(HorusDL.DynamicMenuSideBar dynamicMenuSideBar)
        {
            this.DynamicMenuSideBar = dynamicMenuSideBar ?? new HorusDL.DynamicMenuSideBar();
        }
        ...
        static void ArmarMenu(List<HorusDL.Models.vwDynamicMenuSideBar> aMenu, int modulo, int id, int padre)
        {
